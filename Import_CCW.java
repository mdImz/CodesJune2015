...
public class Import_course_CCW {
		...
		public static void nextWindow(boolean institute, FirefoxDriver fdriver)
		 {
		  ...
		  courseCreation4(fdriver);
		 }

		private static void courseCreation4(FirefoxDriver fdriver) {
			// TODO Auto-generated method stub
			...
			fdriver.findElementById("startDateTimeFormat").clear();
			fdriver.findElementById("startDateTimeFormat").click();
			   ...
			   fdriver.findElementById("endDateTimeFormat").clear();
